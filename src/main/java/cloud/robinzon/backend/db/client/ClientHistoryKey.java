...
public class ClientHistoryKey implements Serializable {
    ...
    public ClientHistoryKey(ClientEntity clientEntity, Timestamp timestamp) {
    ...
    public String toString() {
        return "ClientHistoryKey [clientEntity=" + clientEntity
                + ", timestamp=" + timestamp + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ClientHistoryKey other = (ClientHistoryKey) obj;
