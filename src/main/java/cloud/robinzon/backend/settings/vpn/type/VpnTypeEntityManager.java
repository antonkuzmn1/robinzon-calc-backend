...
import cloud.robinzon.backend.settings.vpn.type.resources.VpnTypeEntityRepository;
import cloud.robinzon.backend.settings.vpn.type.resources.history.VpnTypeHistory;
import cloud.robinzon.backend.settings.vpn.type.resources.history.VpnTypeHistoryRepository;
